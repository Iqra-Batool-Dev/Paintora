        ...
        <form action="" className="flex flex-col items-center w-[100%] h-fit ">
          ...
          <div className="w-[100%] my-2">
            ...
            <input
              ...
              value={data.password}
              onChange={handleChange}
              className="w-full p-2 border-[2px] border-gray-200 rounded-lg outline-primary-300 hover:border-primary-400  bg-transparent text-[0.9rem]"
            />
          ...
          <div className="flex flex-row my-1 gap-1">
            <p className="text-[0.9rem]">Do not have an account?</p>
